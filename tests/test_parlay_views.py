...
def test_matchup_label_puts_away_first_and_attaches_rank_to_the_ranked_side():
    game = make_game(home_team="Georgia", away_team="Marshall")

    assert _matchup_label(1, None, game) == "Marshall vs #1 Georgia"
